...
<head>
  ...
  <title><Kiril Kostov Portfolio - Cookies Policy/></title>

	<!-- Facebook graphs goes here -->
	<!-- Twitter card goes here -->
      ...
      <!--Vertical nav end-->
			...
			<div class="profile-content">
	            ...
	            <div class="container">
								...
								<div class="row well well_tune">
									<div class="col-md-6 col-md-offset-3">
										<p class="title">Cookies Policy</p>
										<p class="title">a) What is a cookie?</p>
										<p class="small_font"><em>The general term for the cookie is: a text file which stores information downloaded on your computer or mobile device (source: https://www.westminster.ac.uk/about-us/our-university/corporate-information/policies-and-documents-a-z/website-terms-of-use/cookies).</em></p>
										<p class="title">b) What cookies do I use and how you can disable them?</p>
										<p class="small_font"><em>I use Google Analytics Cookies to analyse traffic and then make recommendations for improvements regarding the website’s design and web marketing strategies. The whole process serves as a requirement for my coursework. For more information about the cookies I use and how to disable them please visit: https://www.westminster.ac.uk/about-us/our-university/corporate-information/policies-and-documents-a-z/website-terms-of-use/cookies.</em></p>
									</div>
								</div>
							</div>
	        </div>
