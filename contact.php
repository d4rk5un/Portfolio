...
<head>
  ...
  <meta name="description" content="Simple contact form in order to send me your message. Additionaly, you will get 10% discount of your first order!">
  <meta name="keywords" content="newsletter, discount, email, message">

  <title><Kiril Kostov Portfolio - Contact me/></title>

	<!-- Facebook graphs goes here -->
	<meta property="og:url"           content="http://www.kirilkostov.com" />
  <meta property="og:type"          content="website" />
  <meta property="og:title"         content="Kiril Kostov Portfolio - Contact me" />
  <meta property="og:description"   content="Simple contact form in order to send me your message. Additionaly, you will get 10% discount of your first order!" />
...
<!-- Custom JS - track contact form submissions -->
<script>
    ...
    <!-- Header End-->
      ...
      <!--Vertical nav end-->
			...
			<div class="profile-content">
                ...
                <!-- Contact form-->
  							<div class="section landing-section cd-section" id="contact">
  		              <div class="row">
  		                  <div class="col-md-8 col-md-offset-2 col-sm-offset-0 fotter_wd">
  		                      <h2 class="text-center title">Message me now and get <span class="m_red">10% discount</span><br>from our first collaborative project!</h2>
  													<div id="error">
                              <? echo $error.$successMessage; ?>
  													</div>
  								          <h4 class="text-center description">Drop me few lines in the box below if you want to subscribe for my newsletters.</h4>
                                    ...
                                    <div class="col-md-6">
  		                              ...
  		                              <div class="row">
  		                                  <div class="col-md-4 col-md-offset-4 text-center">
  		                                     <button class="btn btn-primary btn-raised btn-lg" type="submit" id="submit" onclick="ga('send', 'event', 'Contact Form', 'submit');">
  												                 Send Message
  											                   </button>
  		                                  </div>
  		                              </div>
